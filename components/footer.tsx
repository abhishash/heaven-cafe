...
function Footer() {
  ...
  return (
    <>
      <footer className="bg-primary sm:block hidden space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-10 py-10">
            ...
            <div className="order-3 sm:order-3">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Button className="justify-start gap-2 cursor-pointer w-fit text-xs sm:text-sm border border-secondary text-black bg-secondary hover:bg-green-100">
                  <svg className="size-6" viewBox="0 0 640 640">
