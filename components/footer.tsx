          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 py-10">
            ...
            <div>
              ...
              <div className="flex flex-row sm:flex-col gap-3">
                <Button className="justify-start w-fit cursor-pointer gap-2 text-xs sm:text-sm border border-black text-black bg-white hover:bg-green-100">
                  <svg className="size-5 fill-black" viewBox="0 0 640 640">
                ...
                <Button className="justify-start gap-2 cursor-pointer w-fit text-xs sm:text-sm border border-black text-black bg-white hover:bg-green-100">
                  <svg className="size-6 fill-black" viewBox="0 0 640 640">
