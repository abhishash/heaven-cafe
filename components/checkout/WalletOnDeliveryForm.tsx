...
export default function WalletOnDeliveryForm({
    ...
    const { data, isLoading: isWalletLoading } = useGetWalletPointQuery();
                ...
                amount > (data?.points || 0) && (
                    <div className="p-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-lg flex gap-2">
                        ...
                        <p className="text-sm text-red-700 dark:text-red-300">
                            You don't have enough wallet points to cover this order.
                        </p>
                    </div>
                )
            }
