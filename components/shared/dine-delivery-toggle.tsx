...
export default function DineDeliveryToggle() {
    ...
    return (
        <div className="flex items-center justify-normal px-4 sm:justify-center gap-4">
            {/* Delivery Label */}
            <span
                className={`text-sm sm:text-lg font-semibold transition-colors duration-300 ${!isDineIn ? 'text-secondary' : 'text-gray-400'
                    }`}
            >
                DELIVERY
            </span>
            ...
            <span
                className={`text-sm sm:text-lg cursor-pointer font-semibold transition-colors duration-300 ${isDineIn ? 'text-secondary' : 'text-gray-400'
                    }`}
            >
